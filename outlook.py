...
class Outlook():
    def __init__(self):
        ...
        #self.imap = imaplib.IMAP4_SSL('eas.outlook.com')
        #self.smtp = smtplib.SMTP('eas.outlook.com', 587)
    ...
    def login(self,username,password):
        ...
        while True:
            try:
                print("\nStarting to signin.")
                self.imap = imaplib.IMAP4_SSL('imap-mail.outlook.com', 993)
  ...
  # I added this function to handle the direct deletion of a message
    def mailstore(self, message_set, command, flags):
        return self.imap.store(message_set, command, flags)
